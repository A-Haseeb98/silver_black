            ...
            <div className='line-up'>
                <Fade triggerOnce={true} direction='up'>
                    <div className='step_Container'>
                        ...
                        <div className='content_container'>
                            <h2>01. ART & COMMUNITY IS OUR FOCUS</h2>
                            <p>7474 unique and digital SILVERBACK LEGENDS, each with their own assets and characteristics, reflect our commitment to the artwork. Our community comes first and so does our dedication to provide invaluable quality and bespoke creations to every enthusiast entering our passionate project.</p>
                        </div>
                    </div>
                </Fade >
                <Fade triggerOnce={true} direction='up'>
                    ...
                    <div className='step_Container'>
                        ...
                        <div className='content_container'>
                            <h2>02. THE BEGINNING</h2>
                            <p>The main goal is to make sure your investment and our mint are as successful as possible. If you are lucky and mint one of our rare NFTs you can very quickly make a big return on your investment within a few days, also you can hold it for longer to let the price grow.</p>
                        </div>
                    </div>
                </Fade>
                <Fade triggerOnce={true} direction='up'>
                    <div className='step_Container'>
                        ...
                        <div className='content_container'>
                            <h2>03. SECOND COLLECTION FREE MINT</h2>
                            <p> We will be launching a female SILVERBACK LEGENDS collection. There will be special benefits and perks unlocked to those who hold both a male & female LEGENDS NFT. All SILVERBACK LEGENDS holders will be able to mint their female LEGENDS NFT for a mint price of 0$.</p>
                        </div>
                    </div>
                </Fade>
                <Fade triggerOnce={true} direction='up'>
                ...
                <Fade triggerOnce={true} direction='up'>
                    ...
                    <div className='step_Container'>
                        ...
                        <div className='content_container'>
                            <h2>05. MARKETING FOR SUCCESS</h2>
                            <p>Meanwhile, we will also be partnering with wisely-selected enterpreneurs, celebrities, and cryptomaniacs, to let them be apart of our journey and we will do the next moves together including but not limited to collaborations, meet ups, and advertisements in the biggest cities in the world.</p>
                        </div>
                    </div>
                </Fade>
                <Fade triggerOnce={true} direction='up'>
                    ...
                    <div className='step_Container'>
                        ...
                        <div className='content_container'>
                            <h2>06. CHARITY TO GIVE BACK</h2>
                            <p>After sellout and reveal of the SILVERBACK LEGENDS, we pledge to donate $100,000 to a gorillas charity or foundation selected by our members. Let’s give back to these amazing creatures, our inspiration, the gorillas.</p>
                        </div>
                    </div>
                </Fade>
                <Fade triggerOnce={true} direction='up'>
                    ...
                    <div className='step_Container'>
                        ...
                        <div className='content_container'>
                            <h2>07. COMMUNITY PROJECTS - WAGMI</h2>
                            <p>We are committed to support, invest, reward, and collaborate with the best projects and project ideas of our members. We will hold contests in our discord and reward and recruit the most creative & innovative ideas and members to join certain projects.</p>
                        </div>
                    </div>
                </Fade>
                <Fade triggerOnce={true} direction='up'>
                    ...
                    <div className='step_Container'>
                        ...
                        <div className='content_container'>
                            <h2>08. METAVERSE IS MANDATORY</h2>
                            <p>
                                ...
                                <ul>
                                    ...
                                    <li>    CAREER Help Meetings for SBL holders with special guests.</li>
                                    <li>      SBL HEALTH SPA (mental health) will create and develop projects with psychologists, health professionals, and experienced trauma survivors to bring awareness and access in the Metaverse about self-care, mental health, mental guidance, trauma awareness & healing, addiction prevention & healing, grieving support, loneliness care-station and many more.</li>
                                    <li>      SBL DESIGN AREA for meetings with Artists, Designers, Architects to work on the first SBL 8 Meta-Star Hotel which will not only take place in the Metaverse.</li>
                                    <li>      SBL FASHION STUDIO for meetings with Fashion Designers, Artists & Enthusiasts to work on the very first SBL Fashion Collection.</li>
                                </ul>
                            </p>
                        </div>
                    </div>
                ...
                {/* <div className='row steps_section'>
                    ...
                    <div >
                        <h3 className='roadMap_steps_heading'><span className='roadMap_steps_heading_blue'>{`0${1}. `}</span> ART & COMMUNITY IS OUR FOCUS  </h3>
                    </div>
